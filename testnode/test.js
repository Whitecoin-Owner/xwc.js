...
let toAddress = "XWCNLhDsXUTy87nGYHfUsCD797MyDCUgXEAgr";
...
function testInvokeContract(tr) {
    var contractId = "XWCCeMwCyGJhQhpXPZoMPYKgWuuh7eEzgCwkS";
    var contractApi = "balanceOf";
    var apiArg = "XWCNUE3EyLeWpN5XA8S4q5DVrbGguWSmPfSoN";
...
function testTransferToContract(tr) {
    let contractId = "XWCCeMwCyGJhQhpXPZoMPYKgWuuh7eEzgCwkS";
    let assetId = "1.3.0";
    let assetAmount = 1;
    let memo = "test";
...
let pubkeystr = "XWCN8mT7XvtTARjdZQ9bqHRoJRMf7P7azFqTQACckaVenM2GmJyxLh ";
...
nodeClient
    ...
    .then(function() {
        ...
        nodeClient
            .getAccountByAddresss("XWCNdkruwzhKc8EQKVNirF7xPLLpEojResJcZ")
            .then(r => {
