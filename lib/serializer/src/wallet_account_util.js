...
export default {
    // decode from xwc pc wallet wallet.json
    decodeWalletJson(walletJson, password) {
        const walletInfo = new XwcAccountsWalletInfo(walletJson);
